...
class BudgetManager(BaseManager):
    ...
    def delete_budget(self, budget_id, workspace_id, domain_id):
        budget_vo: Budget = self.get_budget(budget_id, domain_id, workspace_id)
        budget_vo.delete()

    def get_budget(self, budget_id: str, domain_id: str, workspace_id: str = None):
